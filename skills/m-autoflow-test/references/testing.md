...
Use this reference for the optional heavy validation phase of `m-autoflow`.

## Scope Boundary

- Lightweight syntax, typecheck, formatting, lint, targeted unit tests, and `git diff --check` belong in `$m-autoflow-execute`.
