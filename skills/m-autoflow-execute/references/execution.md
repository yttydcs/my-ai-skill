...
Use this reference for the implementation phase of `m-autoflow`.
...
Record any skipped lightweight check with the reason and residual risk. Reserve heavy integration, end-to-end, usability, security, and performance review for `$m-autoflow-test`.
