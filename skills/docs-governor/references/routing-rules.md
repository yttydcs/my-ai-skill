...
1. Ask whether the content is long-lived truth or workflow-specific history.
2. If it is long-lived truth:
   - user need, scope, acceptance -> `requirements`
   - technical contract, protocol, architecture, schema -> `specs`
3. If it is workflow history:
