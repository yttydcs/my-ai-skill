...
3. Determine the canonical destination:
   ...
   - reusable incident knowledge belongs in `lessons`
...
5. Write the minimum consistent set of files:
   ...
   - root `docs/README.md` only if entry topology changes
...
7. Cross-link related artifacts so the docs chain remains navigable.
