...
Use this reference for optional web research in `m-autoflow`.

## Optionality

- This phase is not mandatory.
- Invoke it only when the user explicitly asks for online research, web search, source-backed investigation, or current external information.
- Do not infer a need for web research from ordinary implementation planning when repo docs and code are sufficient.
...
- workflow-specific research summary -> active `plan.md` or later `docs/change`
